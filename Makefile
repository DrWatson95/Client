...
# Template: app
# Command: /opt/Qt/6.2.1/gcc_64/bin/qmake -o Makefile MyClient.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug
#############################################################################
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = MyClient1.0.0
DISTDIR = /home/konstantin/QtProjects/MyClient/.tmp/MyClient1.0.0
LINK          = g++
...
Makefile: MyClient.pro /opt/Qt/6.2.1/gcc_64/mkspecs/linux-g++/qmake.conf /opt/Qt/6.2.1/gcc_64/mkspecs/features/spec_pre.prf \
	...
	$(QMAKE) -o Makefile MyClient.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug
...
moc_myclient.cpp: myclient.h \
		...
		/opt/Qt/6.2.1/gcc_64/include/QtWidgets/QVBoxLayout \
...
install_target: first FORCE
	@test -d $(INSTALL_ROOT)/opt/MyClient/bin || mkdir -p $(INSTALL_ROOT)/opt/MyClient/bin
	$(QINSTALL_PROGRAM) $(QMAKE_TARGET) $(INSTALL_ROOT)/opt/MyClient/bin/$(QMAKE_TARGET)

uninstall_target: FORCE
	-$(DEL_FILE) $(INSTALL_ROOT)/opt/MyClient/bin/$(QMAKE_TARGET)
	-$(DEL_DIR) $(INSTALL_ROOT)/opt/MyClient/bin/ 
